...
main() {
    ...
    echo "  1. Kubeconfig is automatically merged to ~/.kube/config"
    echo "  2. Verify cluster: kubectl get nodes"
    echo "  3. Check GPU availability: kubectl get nodes -o json | jq '.items[].status.capacity.\"nvidia.com/gpu\"'"
